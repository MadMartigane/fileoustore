...
- If the code is modified, it must systematically check the code via the linter and the formatter.
  ...
  - Run `pnpm run doctor` to diagnose any setup issues.
  ...
  - **Diagnose setup**: `pnpm run doctor`
  ...
  Most formatting and common issues are automatically fixed by Biome. Run `pnpm run format` before committing to ensure compliance.
